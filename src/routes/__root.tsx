...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BIOVISAGE — Estética e Beleza Facial" },
      {
        name: "description",
        content: "Clínica de estética facial em Guaxupé, MG, com a Dra. Suellen Paiva.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500&family=Great+Vibes&family=Jost:wght@300;400;500&display=swap",
      },
    ],
  }),
